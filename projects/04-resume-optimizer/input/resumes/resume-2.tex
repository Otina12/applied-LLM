...
\cvEntryNTPLD
    ...
    \cvItem{Designed and maintained backend services for investment and banking products used by thousands of users}
    \cvItem{Implemented REST APIs with authentication, authorization, and role based access control}
    \cvItem{Worked closely with product owners and frontend teams to deliver business critical features}
}
\cvEntryNTPLD
    {EPAM}
    {Feb 2021 -- Jan 2022}
    ...
    \cvItem{Worked on cloud based systems deployed on AWS and Azure}
    \cvItem{Collaborated in distributed teams using Agile and Scrum processes}
}
\cvEntryNTPLD
    {Saatec Ltd.}
    {Mar 2019 -- Feb 2021}
    ...
    {2023}
{
    ...
    \cvItem{Built a backend system to manage user portfolios, transactions, and asset history}
    \cvItem{Implemented data validation, error handling, and basic analytics}
}
\cvEntryPersonalNTD
    ...
    {2022}
{
    ...
    \cvItem{Created a full CRUD backend with authentication and role management}
    \cvItem{Designed database schema and API contracts from scratch}
}
