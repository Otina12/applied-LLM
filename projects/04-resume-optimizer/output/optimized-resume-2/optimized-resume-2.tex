...
\def \summaryText{Backend focused .NET developer with strong experience in building scalable APIs, financial systems, and internal platforms. Experienced in designing clean architectures, working with cloud services, and improving system reliability and performance. Comfortable working in cross functional teams and owning features end to end.}
...
\cvEntryNTPL
    {Relevant Coursework}
    {2020 -- 2024}
    {Algorithms, Databases, Distributed Systems, Software Engineering}
    {Academic}
...
\cvEntryNTPLD
    ...
    {Georgia}{
    \cvItemS{C\#, .NET, ASP.NET Core, SQL Server, Azure, Docker, CI/CD}
    \cvItem{Designed and maintained backend services for insurance-related investment and banking products, ensuring high performance and reliability for thousands of users.}
    \cvItem{Implemented REST APIs with authentication, authorization, and role based access control}
    \cvItem{Collaborated effectively with product owners and frontend teams to deliver business-critical features, demonstrating strong communication and teamwork skills.}
}
\cvEntryNTPLD
    {EPAM}
    {Feb 2021 -- Jan 2022}
    {Middle .NET Engineer}
    {Georgia}{
    \cvItemS{C\#, .NET, ASP.NET Core, AWS, Azure, PostgreSQL}
    \cvItem{Worked on highly scalable cloud-based systems deployed on AWS and Azure, ensuring effective communication within the team.}
    \cvItem{Collaborated in highly distributed teams using Agile and Scrum methodologies, focusing on effective communication and collaboration.}
}
\cvEntryNTPLD
    {Saatec Ltd.}
    {Mar 2019 -- Feb 2021}
    ...
    {Georgia}{
    \cvItemS{C\#, .NET, SQL Server, WinForms, ASP.NET}
    \cvItem{Developed internal tools and business applications for retail and e commerce systems}
    \cvItem{Worked with relational databases and wrote complex SQL queries}
}
...
\cvEntryAcademicalNTD
    {Stock Portfolio Management System}
    {2023}
{
    \cvItemS{C\#, .NET, REST APIs, SQL, Design Patterns}
    \cvItem{Built a backend system for managing user portfolios, transactions, and asset history in a highly scalable environment.}
    \cvItem{Implemented data validation, error handling, and basic analytics in a team environment, focusing on modern software development practices.}
}
\cvEntryPersonalNTD
    {Task Management and To Do Application}
    {2022}
{
    \cvItemS{ASP.NET Core, Entity Framework, PostgreSQL, Docker}
    \cvItem{Developed a full CRUD backend integrated with authentication and role management, ensuring effective functionality and security within a collaborative environment.}
    \cvItem{Designed highly scalable database schema and API contracts from scratch, collaborating with a team of developers and designers.}
}
...
\cvEntryND{
    \cvItemND{Languages}{C\#, SQL, Python, JavaScript}
    \cvItemND{Backend}{.NET, ASP.NET Core, Web APIs, Entity Framework, Dapper}
    \cvItemND{Databases}{SQL Server, PostgreSQL, Indexing, Query Optimization}
    \cvItemND{Cloud and DevOps}{Azure, AWS, Docker, CI/CD pipelines}
    \cvItemND{Architecture}{Clean Architecture, SOLID principles, Design Patterns}
}
...
\cvEntryND{
    \cvItemND{Backend Systems}{Interested in scalable systems, performance tuning, and reliability}
    \cvItemND{Distributed Systems}{Enjoy learning how large scale systems handle data and failures}
    \cvItemND{Finance and Investing}{Interested in stock markets, trading platforms, and financial products}
}
